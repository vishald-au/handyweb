...
<div class="row">   
    <div class="col-sm-6">
<input class="main-inp" type="number" name="from" id="from" placeholder="Moving From (Zip only)" required>

    </div>
    <div class="col-sm-6">
<input class="main-inp" type="number" name="to" id="to" placeholder="Moving To (Zip only)" required>
...
<input class="main-inp" type="text" name="email" placeholder="Email" id="email">
    ...
    <div class="col-sm-6">
    <input class="sub-inp" type="submit" value="SEND MESSAGE">
</div>
</div>
